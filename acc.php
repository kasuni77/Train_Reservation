...
<!-- Form -->
		...
		<center>
			...
			<input type="text" name="fullname" placeholder="Name" class = "name" required name  = "fullname"> <br>
			
			<input type="email" name="email" placeholder="abc@gmail.com" class = "mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required name  = "email">
		...
		<button onclick = "validate()" class= "changes" id = "change">Edit Profile</button>
    </form>
</div>
